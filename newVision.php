...
#vnm{
    ...
    background:url("target-hovers.png")no-repeat transparent 10px 10px;
...
<body>
    <div class="divpage">
        ...
        <div class="aboutusCont">
            ...
            <div class="backgroundCont"><label id="bckLabel">Vision</label>
            
            <?php include("visionmissionSection.php"); ?>
